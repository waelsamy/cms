...
class Cpp17GppARM(CompiledLanguage):
    """This defines the C++ programming language, compiled with g++ (the
    version available on the system) using the C++17 standard For ARM.
    ...
    def get_compilation_commands(self,
        ...
        command += ["-std=gnu++17", "-O2", "-pipe", "-static",
                    "-s","-march=armv8-a+crc+crypto","-mtune=cortex-a72", "-Ofast", "-o", executable_filename]
